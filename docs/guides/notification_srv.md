...
| --- | --- | --- |
| **Notification service** | `cidaas_notifications_template_group`, `cidaas_notifications_template_group_locale`, `cidaas_notification_template_type`, `cidaas_notification_template`, graph datasources | **notification-srv** under `/{notifications_context_path}/…` |
