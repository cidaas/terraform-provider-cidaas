...
-> **Note:** `cidaas_hosted_page` is the single unified hosted page resource across `4.x` target versions. It natively supports hosted page URLs, custom CSS theme, localized translations, and branding layout in a single resource block.
