...
- `communication_methods` (Set of String) Supported communication methods: `email`, `sms`, `ivr`, `push`.
...
- `description` (String) Description of what this template type is used for.
