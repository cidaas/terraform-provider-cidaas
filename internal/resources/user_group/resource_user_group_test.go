...
func TestUserGroup_Basic(t *testing.T) {
	...
	testResourceName := fmt.Sprintf("%s.%s", base.RESOURCE_USER_GROUP, testResourceID)
	resourceGroupTypeName := fmt.Sprintf("%s.%s", base.RESOURCE_GROUP_TYPE, testResourceID)
...
func testCheckUserGroupDestroyed(resourceID string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		resourceGroupName := fmt.Sprintf("%s.%s", base.RESOURCE_USER_GROUP, resourceID)
		...
		resourceGroupTypeName := fmt.Sprintf("%s.%s", base.RESOURCE_GROUP_TYPE, resourceID)
