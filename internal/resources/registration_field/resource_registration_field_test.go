package registrationfield_test
...
func TestRegistrationField_CheckBoxBasic(t *testing.T) {
	...
	testResourceName := fmt.Sprintf("%s.%s", base.RESOURCE_REGISTRATION_FIELD, fieldKey)
...
func TestRegistrationField_OrderUpdate(t *testing.T) {
	...
	resourceName := fmt.Sprintf("%s.%s", base.RESOURCE_REGISTRATION_FIELD, fieldKey)
